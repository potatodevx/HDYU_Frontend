...
const NAV = [
  ...
  { href: "/admin/rewards", label: "Reward Approvals", icon: HandCoins },
    ...
    <div className="flex h-full flex-col">
      <Link href="/" className="flex items-center gap-2.5 px-6 py-6">
        ...
        <div>
          ...
          <span className="ml-2 rounded-md bg-red-400/15 px-1.5 py-0.5 text-[10px] font-bold uppercase tracking-wider text-red-300">
            Admin
          </span>
        </div>
      </Link>
      ...
      <div className="border-t border-white/5 p-4">
        <div className="mb-3 flex items-center gap-2 rounded-xl bg-red-400/8 px-3.5 py-2.5 text-xs text-red-200/80">
          <ShieldAlert size={14} className="shrink-0" />
          Treasury actions are logged to the audit trail.
        </div>
    ...
    <div className="flex min-h-screen">
      ...
      <div className="glass-strong fixed inset-x-0 top-0 z-40 flex h-14 items-center justify-between px-4 lg:hidden">
        <div className="flex items-center gap-2">
          ...
          <span className="font-display font-bold text-white">HDYU Admin</span>
        </div>
